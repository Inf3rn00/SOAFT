            ...
            <div className="flex flex-col">
              ...
              {!signedIn ? (
                ...
                <form action="" className="my-3">
                  ...
                  <p className="my-3">
                    ...
                    <a href="#" className="text-[#5046E5]">Terms of Service</a> and{" "}
                    <a href="#" className="text-[#5046E5]">Privacy Policy</a>
                  </p>
              ...
              {signedIn ? (
                <p className="text-center font-medium">
                  ...
                  <a onClick={() => setSignedIn(false)} className="text-[#5046e5] hover:cursor-pointer">
                    Create account
                  </a>
                </p>
              ) : (
                <p className="text-center font-medium">
                  ...
                  <a onClick={() => setSignedIn(true)} className="text-[#5046e5] hover:cursor-pointer">
                    Sign in
                  </a>
                </p>
              )}
