  ...
  // The logic reference
    ...
    return (
        <div className="flex justify-center items-center mt-15">
            <div className={`flex items-center  w-[1000px] ${signedIn ? "h-[500px]": "h-[750px]"}`}>
                {/* The left panel */}
                <div
                className="bg-[rgba(80,70,229,1)]  opacity-95 rounded-l-xl
                        p-7 text-[#ffffff] w-[50%] h-full flex justify-center items-center"
                >
                <div className={`flex flex-col ${!signedIn ?"gap-y-36": ""}`}>
                    <div>
                        ...
                        {!signedIn ? 
                            <form action="" className="my-3">
                                ...
                                <div className="my-2">
                                    ...
                                    <input type="email" className="block bg-[#E2E3E5] h-8 w-full"/>
                                    <p className="text-sm font-thin text-[#DC3545]">Email must consist of your full name</p>
                                </div>
                                <div>
