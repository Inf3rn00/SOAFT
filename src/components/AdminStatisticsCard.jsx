  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-x-4 p-3">
      ...
      {statistics.map((stat, index) => (
        <div
          key={index}
          className="flex items-center justify-between p-2 bg-[#ffffff] rounded-[8px] shadow-md"
        >
          <div className="flex justify-between items-center w-full p-3">
            {/* Statistics Info */}
            <div className="flex flex-col gap-5">
              {/* Statistics Title */}
              <h3 className="text-[#2e2e2e] text-[18px] font-semibold">
                {stat.title}
              </h3>
              {/* Statistics Quantity */}
              ...
              >
                ...
                <span className="text-[#6c757d] font-semibold">
                  {" "}
                  {stat.updatefrom}
                </span>
              </p>
